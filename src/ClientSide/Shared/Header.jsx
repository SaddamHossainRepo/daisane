        ...
        `}
                ...
                <div className="flex items-center justify-between ">
                    ...
                    <div className="flex xl:mx-[140px] 2xl:mx-[250px]  menu menuSize" style={poppinsFontStyle}>
                        <Link to="/" className="2xl:mr-[70px] lg:mr-[20px] xl:mr-[40px] font-bold text-[20px] menuGap menuSize">Home</Link>
                        <Link to="/priorities" className="2xl:mr-[70px] lg:mr-[20px] xl:mr-[40px] font-bold text-[20px] menuGap menuSize">Prioritites</Link>
                        <Link to="/endorsements" className="2xl:mr-[70px] lg:mr-[20px] xl:mr-[40px] font-bold text-[20px] menuGap menuSize">Endorsements</Link>
