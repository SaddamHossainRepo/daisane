...
const Youtube = () => {
    return (
        <div>
            <div className=" relative lR leftRightW 2xl:mb-[250px] mb-[60px] lg:h-[540px] xl:mb-[200px] 2xl:w-[1620px] xl:w-[1270px] w-[310px] h-[198.14px] md:w-[93%] md:h-[400px] 2xl:h-[927px] xl:h-[751px] youTubeHeightWidth mx-auto  youTubeHeight">
            <iframe
